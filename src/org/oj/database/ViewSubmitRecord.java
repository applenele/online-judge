...
public interface ViewSubmitRecord extends BaseFunction {
    ...
    List<ViewSubmitRecordBean> getSubmitRecordListByUserName(@Param("contestID") Integer contestID, @Param("problemID") Integer problemID, @Param("userName") String userName, @Param("result") String result, @Param("language") String language, @Param("start") Integer start, @Param("count") Integer count);
